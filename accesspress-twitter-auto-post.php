...
/**
 * Plugin Name: TAuto Poster
 * Plugin URI: https://accesspressthemes.com/wordpress-plugins/accesspress-twitter-auto-post/
 * Description: A plugin to publish your wordpress posts to your twitter account
 * Version: 1.4.7
...
if (!class_exists('ATAP_Class')) {
    ...
    class ATAP_Class {
        ...
        function plugin_row_meta( $links, $file ){
            if ( strpos( $file, 'accesspress-twitter-auto-post.php' ) !== false ) {
                $new_links = array(
                    'doc' => '<a href="https://accesspressthemes.com/documentation/accesspress-twitter-auto-post/" target="_blank"><span class="dashicons dashicons-media-document"></span>Documentation</a>',
        ...
        function admin_footer_text( $text ){
            if ( isset( $_GET[ 'page' ] ) && $_GET[ 'page' ] == 'atap') {
                $link = 'https://wordpress.org/support/plugin/accesspress-twitter-auto-post/reviews/#new-post';
                $pro_link = 'https://accesspressthemes.com/wordpress-plugins/accesspress-social-auto-post/';
                $text = 'Enjoyed TAuto Poster? <a href="' . $link . '" target="_blank">Please leave us a ★★★★★ rating</a> We really appreciate your support! | Try premium version of <a href="' . $pro_link . '" target="_blank">AccessPress Social Auto Post</a> - more features, more power!';
                return $text;
            } else {
                return $text;
            }
      ...
      function redirect_to_site(){
            if ( isset( $_GET[ 'page' ] ) && $_GET[ 'page' ] == 'tautoposter-doclinks' ) {
                wp_redirect( 'https://accesspressthemes.com/documentation/accesspress-twitter-auto-post/' );
                exit();
            }
            if ( isset( $_GET[ 'page' ] ) && $_GET[ 'page' ] == 'tautoposter-premium' ) {
        ...
        function atap_admin_menu() {
            add_menu_page(__('TAuto Poster', 'accesspress-twitter-auto-post'), __('TAuto Poster', 'accesspress-twitter-auto-post'), 'manage_options', 'atap', array($this, 'plugin_settings'),'dashicons-twitter');
           add_submenu_page('atap', __( 'Documentation','accesspress-twitter-auto-post' ), __( 'Documentation', 'accesspress-twitter-auto-post'  ), 'manage_options', 'tautoposter-doclinks', '__return_false', null, 9 );
            add_submenu_page('atap', __( 'Check Premium Version', 'accesspress-twitter-auto-post'  ), __( 'Check Premium Version', 'accesspress-twitter-auto-post'  ), 'manage_options', 'tautoposter-premium', '__return_false', null, 9 );
        }
        ...
        function register_admin_assets() {
            if (isset($_GET['page']) && $_GET['page'] == 'atap') {
                wp_enqueue_style('atap-fontawesome-css', ATAP_CSS_DIR.'/font-awesome.min.css', ATAP_VERSION);
        ...
        function add_atap_meta_box($post_type) {
            add_meta_box(
                    'atap_meta_box'
                    , __('TAuto Poster', 'accesspress-twitter-auto-post')
        ...
        function save_atap_meta_value($post_id) {
            ...
            $nonce = sanitize_text_field($_POST['atap_meta_box_nonce_field']);
